...
class AREffect3 extends StatefulWidget {
  @override
  _AREffect3State createState() => _AREffect3State();
}

class _AREffect3State extends State<AREffect3> {
          ...
          children: [
            ...
            Align(
              ...
              child: Container(
                ...
                //    Text("ar3",style: TextStyle(color: Colors.white),),
                    SizedBox(
                      //height: 20,
                    ),
                    Container(
