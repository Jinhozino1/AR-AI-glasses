...
class AREffect1 extends StatefulWidget {
  @override
  _AREffect1State createState() => _AREffect1State();
}

class _AREffect1State extends State<AREffect1> {
